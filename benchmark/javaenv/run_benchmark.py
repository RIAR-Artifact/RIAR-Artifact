...
REDUCERS = {
    ...
    "vulcan": os.path.join(__location__, "binaries", "run_vulcan.sh"),
    "vulcan-plus": os.path.join(__location__, "binaries", "run_vulcan_plus.sh"),
    "vulcan-EE": os.path.join(__location__, "binaries", "run_vulcan_EE.sh"),
    "vulcan-IR": os.path.join(__location__, "binaries", "run_vulcan_IR.sh"),
    "vulcan-SR": os.path.join(__location__, "binaries", "run_vulcan_SR.sh"),
}
