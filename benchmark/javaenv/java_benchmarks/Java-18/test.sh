...
class="compiler.intrinsics.bigInteger.TestMultiplyToLen"
...
cp TestMultiplyToLen.java compiler/intrinsics/bigInteger/TestMultiplyToLen.java
python3 $javaMender $script_dir/compiler/intrinsics/bigInteger/TestMultiplyToLen.java
if ! /01JVMS/linux64/openjdk11/openj9_11/bin/javac -cp $classpath compiler/intrinsics/bigInteger/TestMultiplyToLen.java
then
        exit 1
fi
> out1.txt
